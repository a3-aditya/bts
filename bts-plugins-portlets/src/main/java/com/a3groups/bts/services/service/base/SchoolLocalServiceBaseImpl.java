...
import com.a3groups.bts.services.service.SchoolLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.a3groups.bts.services.service.impl.SchoolLocalServiceImpl}.
 * </p>
 *
 * @author A3 Groups Inc.
 * @see com.a3groups.bts.services.service.impl.SchoolLocalServiceImpl
 * @see com.a3groups.bts.services.service.SchoolLocalServiceUtil
 * @generated
 */
public abstract class SchoolLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements SchoolLocalService, IdentifiableBean {
    ...
    private SchoolLocalServiceClpInvoker _clpInvoker = new SchoolLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.a3groups.bts.services.service.SchoolLocalServiceUtil} to access the school local service.
     */
    ...
    @Override
    public School addSchool(School school) throws SystemException {
        school.setNew(true);
     ...
     */
    @Override
    public School createSchool(int id) {
        return schoolPersistence.create(id);
    }
    ...
    @Override
    public School deleteSchool(int id) throws PortalException, SystemException {
        return schoolPersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public School deleteSchool(School school) throws SystemException {
    ...
    @Override
    public School fetchSchool(int id) throws SystemException {
        return schoolPersistence.fetchByPrimaryKey(id);
    }
     ...
     */
    @Override
    public School getSchool(int id) throws PortalException, SystemException {
        return schoolPersistence.findByPrimaryKey(id);
    }
     ...
     */
    @Override
    public int getSchoolsCount() throws SystemException {
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public School updateSchool(School school) throws SystemException {
        return schoolPersistence.update(school);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.a3groups.bts.services.model.School",
            schoolLocalService);
    }
